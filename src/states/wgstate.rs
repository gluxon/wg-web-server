...
use wireguard_uapi::socket::GetDeviceArg;
...
pub struct WgState {
    ...
    pub socket: Mutex<wireguard_uapi::Socket>,
...
impl WgState {
    pub fn init(interface_name: String) -> Result<Self, ConnectError> {
        Ok(Self {
            socket: Mutex::new(wireguard_uapi::Socket::connect()?),
